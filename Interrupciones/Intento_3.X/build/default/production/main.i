...
# 343 "./mcc_generated_files/tmr6.h"
 void TMR6_SetInterruptHandler(void (* InterruptHandler)(void));
# 361 "./mcc_generated_files/tmr6.h"
...
volatile char Bandera_ADC = 0;
volatile char Bandera_Timer = 0;
...
void main(void){
 ...
 ADC_Initialize();
    ...
    ADCON1 = 0b11100000;
 Ds_Iniciar_displays (&My_Display, 4, 5, 6, 4, 1);
    TMR6_StartTimer();
 ...
 TMR6_SetInterruptHandler(Funcion_a_llamar_Timer6_Interruciones);
  ...
  if(Bandera_Timer){
    ...
    Tm_Baje_periodico(&My_Per_1000ms);
                ADC_StartConversion();
                enviar = 1;
  }
